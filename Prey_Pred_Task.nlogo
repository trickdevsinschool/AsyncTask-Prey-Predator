...
to move
  forward 1
  set energy energy - 0.4 ;; reduce the energy by the cost of movement
end
...
to eat-grass
  ...
  if ( grass-amount >= 1.7 ) [
    ;; increment the cow's energy
    set energy energy + 1.7
    ;; decrement the grass
    set grass-amount grass-amount - 1.7
    recolor-grass
  ]
...
to eat-cows
  if any? cows-here [  ;; if there are cows here then eat one
    ifelse any? barns-here[
      set energy energy + 0
            ]
