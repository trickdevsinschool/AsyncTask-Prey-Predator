...
to Setup
  ...
  create-cows number-of-cows [  ;; create the initial sheep
    setxy random-xcor random-ycor
    set color white
    set shape "cow"
    set energy 100
    ;set label energy  ;; set the initial energy to 100
  ]
  create-barns number-of-barns [  ;; create the initial sheep
    setxy random-xcor random-ycor
    set color red
  ...
  create-ufos number-of-ufos [  ;; create the initial wolves
    setxy random-xcor random-ycor
    set color blue
    set shape "ufo side"
...
to move
  forward 1
  set energy energy - 0.5 ;; reduce the energy by the cost of movement
end
...
to eat-grass
   ...
   set energy energy + 1.7
   ;; decrement the grass
   set grass-amount grass-amount - 0.2
   recolor-grass


end
to eat-cows
  if any? cows-here [  ;; if there are sheep here then eat one
    ifelse any? barns-here[set energy energy + 0]
